        ...
        <section>
            <div className="mx-auto mt-10 container flex flex-wrap flex-row tablet:items-center tablet:text-left text-center justify-between px-10">
                <div className="relative tablet:w-6/12 tablet:mb-0 mb-5 space-y-4">
                    <p className="font-bold tablet:text-5xl text-3xl text-303030">Lorem ipsum dolor sit amet</p>
                    <p className="tablet:text-2xl text-xl italic text-585858 max-w-md">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
                </div>
                <div className="relative h-full ml-auto tablet:w-5/12 justify-items-end">
                    <img src="/assets/body1.png" className="tablet:max-h-96 m-auto" alt="" />
                </div>
            </div>
        </section>
        ...
        <section className="bg-gray-50">
            <div className="mx-auto container mt-20 px-10">
                ...
                <Swiper onSlideChange={() => console.log('slide change')} onSwiper={(swiper) => console.log(swiper)}>
                    <SwiperSlide>
                    <div class="w-full mr-3 max-w-mini bg-white rounded-lg shadow-md">
                            <a href="/">
                                <img class="rounded-t-lg" src="/assets/card1.png" alt="product" />
                            </a>
                            <div class="px-5 pb-5">
                                <a href="/">
                                    <h5 class="truncate ... overflow-hidden text-xl font-semibold tracking-tight text-gray-900 ... mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque numquam suscipit voluptas delectus minus! Cumque ex, laudantium laboriosam ea quisquam earum sunt aspernatur porro quibusdam, voluptates est illo tempore molestias.</h5>
                                </a>
                                <div class="flex items-center mb-3"></div>
                                <div class="flex justify-between items-center">
                                    <div class="flex flex-row items-center">
                                        <img src="/assets/muka1.jpeg" class="h-9 w-9 mr-2 rounded-full" alt="" />
                                        <label class="font-medium text-gray-700">Nama Manusia</label>
                                    </div>
                                    <div class="flex flex-row items-center text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
