            ...
            <div className="relative h-full ml-auto lg:w-7/12 flex items-center">
                <div className="m-auto py-12 px-6 sm:p-20 xl:w-10/12">
                    <div className="space-y-5">
                        ...
                        <p className="font-medium text-lg text-gray-500">Welcome to Devla ! Forgot Password?</p>
                    </div>

                    <form onSubmit={forgotHandler} method='POST' className="space-y-6 mt-10">
                        ...
                        <div className="relative flex items-center">
                            ...
                            <input type="email" placeholder="Email" name="email" className="w-full py-3 pr-3 pl-12 ring-1 ring-gray-300 rounded-xl placeholder-gray-600 bg-transparent transition disabled:ring-gray-200 disabled:bg-gray-100 disabled:placeholder-gray-400 invalid:ring-red-400 focus:invalid:outline-none" />
                        </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="w-max p-3 mx-auto">
                                <span className="text-sm tracking-wide">Already remember? <a href="/" className="text-sm text-orange-500">Login</a></span>
                            </p>
                        </div>
                    </form>
                </div>
